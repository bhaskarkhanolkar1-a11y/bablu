    ...
    <div className="min-h-screen flex items-center justify-center p-6">
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="flex items-center gap-4 justify-center">
          ...
          <div className="w-24 text-center text-3xl font-semibold tabular-nums">
            {quantity}
          </div>
          <Button
            variant="outline"
...
export default function Page() {
  return (
    <Suspense
      fallback={<div className="min-h-screen flex items-center justify-center p-6">Loading item…</div>}
    >
      <ItemPageClient />
    </Suspense>
  );
